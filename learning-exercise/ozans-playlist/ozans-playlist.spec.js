...
describe('removeDuplicates', () => {
  ...
  test('My own test for big playlist', () => {
    const TRACK_1 = 'Two Paintings and a Drum - Carl Cox';
    const TRACK_2 = 'Leash Called Love - The Sugarcubes';
    const TRACK_3 = 'The Fashion Show - Grace Jones';
    const TRACK_4 = 'Dr. Funkenstein - Parliament';
    const TRACK_5 = 'Atomic Dog - George Clinton';
    const playlist = [TRACK_1, TRACK_3, TRACK_4, TRACK_1, TRACK_1, TRACK_4, TRACK_5, TRACK_2, TRACK_1, TRACK_4, TRACK_5, TRACK_2];
    const expected = [TRACK_1, TRACK_3, TRACK_4, TRACK_5, TRACK_2];
